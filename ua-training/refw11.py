...
def plotdiferentmedia(point):
    ...
    plt.subplot(2, 3, 1)
    rezults.append(plotsinglespec(f"experiments/027/{point}.asc","PBS-reflectance","cyan",1))
    rezults.append(plotsinglespec(f"experiments/032/{point}.asc", "DNS-reflectance","blue",2))
    rezults.append(plotsinglespec(f"experiments/040/{point}.asc","BSA-reflectance","purple",3))
    rezults.append(plotsinglespec(f"experiments/043/{point}.asc","VEGF100-reflectance","green",4)) 
    rezults.append(plotsinglespec(f"experiments/046/{point}.asc","VEGF500-reflectance","red",5))
    rezults.append(plotsinglespec(f"experiments/049/{point}.asc","VEGF1000-reflectance","orange",6))
